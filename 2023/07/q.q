...
m:("23456789TJQKA";"J23456789TQKA")!\:2+til 13         / (m)ap from cards to numbers (larger number being stronger)
-1"part 1 ans: ",string f[p;m 0;::];                   / part 1 ans
u:{@'[d;x^(first idesc@)@'d:y _'2;+;0^y@'x]}m[1]"J"    / (u)pdate card number by reallocating "J" to next max count card
